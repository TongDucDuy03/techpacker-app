...
const translations: Record<LanguageCode, TranslationDict> = {
  en: {
    ...
    'form.bom.selectFromColorway': 'Select from colorway',
    'form.bom.enterCustomText': 'Enter custom text',
    'form.bom.customColorName': 'Custom color name',
    'form.bom.enterColorName': 'Enter color name...',
    'form.bom.customColorCode': 'Custom color code',
    'form.bom.enterColorCode': 'Enter color code...',
    'form.bom.customColorImage': 'Custom image',
    ...
    'form.packing.modalTitle': 'Packing Item Details',
    'form.packing.imageLabel': 'Illustration Image',
    'form.packing.noteLabel': 'Note',
    'form.packing.listTitle': 'Packing Items List',
    'form.packing.imageColumn': 'Image',
    'form.packing.noteColumn': 'Note',
    'form.packing.addButton': 'Add Packing',
    'form.packing.noNote': 'No note yet',
    'form.packing.imageUploaded': 'Image uploaded successfully',
    'form.packing.imageHint': 'PNG, JPG, GIF, SVG up to 5MB. One packing image only.',
    'form.packing.deleteConfirm': 'Are you sure you want to delete this packing item?',
    'form.packing.duplicate': 'Duplicate',
    'form.packing.empty': 'No packing items yet. Click "Add Packing" to add one.',
    ...
    'form.revision.revisionTitle': 'Revision {{version}}',
    'form.revision.byUser': 'By {{name}} • {{date}}',
    'form.revision.compare': 'Compare',
    'form.revision.revert': 'Revert',
    'form.revision.changeSummary': 'Change Summary',
    'form.revision.noSummary': 'No summary provided',
    'form.revision.fieldChanges': 'Field Changes',
    'form.revision.noDetailedDiff': 'No detailed field-level diff available, but changes were detected:',
    'form.revision.added': 'added',
    'form.revision.modified': 'modified',
    'form.revision.removed': 'removed',
    'form.revision.noFieldChanges': 'No field-level changes detected in this revision.',
    'form.revision.field': 'Field',
    'form.revision.oldValue': 'Old Value',
    'form.revision.newValue': 'New Value',
    'form.revision.comments': 'Comments',
    'form.revision.noCommentsYet': 'No comments yet',
    'form.revision.addCommentPlaceholder': 'Add a comment...',
    'form.revision.sendComment': 'Send Comment',
    'form.revision.confirmRevert': 'Confirm Revert',
    'form.revision.revertConfirmMessage': 'Are you sure you want to revert to version <strong>{{version}}</strong>?',
    'form.revision.revertDescription': 'This action will create a new revision and record history. Current data will be replaced with data from this revision.',
    'form.revision.originalSummary': 'Original Summary:',
    'form.revision.revertReasonLabel': 'Revert reason (optional)',
    'form.revision.revertReasonPlaceholder': 'Enter revert reason (if any)...',
    'form.revision.compareRevisions': 'Compare Revisions',
    'form.revision.fromRevision': 'From Revision',
    'form.revision.toRevision': 'To Revision',
    'form.revision.selectRevision': 'Select revision',
    'form.revision.comparing': 'Comparing revisions...',
    'form.revision.comparisonSummary': 'Comparison Summary',
    'form.revision.noDifferences': 'No differences found between these revisions.',
    'form.revision.showingFirst100': 'Showing first 100 fields',
    'form.revision.moreDifferences': 'There are more differences. Use the API to fetch additional fields.',
    'form.revision.cannotRevertNoSnapshot': 'Cannot revert — snapshot data missing for this revision',
    'form.revision.cannotRevertRollback': 'Reverting to a rollback revision is not allowed',
    'form.revision.isCurrentRevision': 'This is the current revision',
    'form.revision.needEditorAccess': 'You need Editor access to revert this TechPack',
    'form.revision.section.bom': 'BOM',
    'form.revision.section.measurements': 'Measurements',
    'form.revision.section.colorways': 'Colorways',
    'form.revision.section.howToMeasure': 'How to Measure',
    'form.revision.section.articleInfo': 'Article Info',
    'form.revision.section.articleInformation': 'Article Information',
    'form.revision.section.bomItems': 'BOM Items',
    'form.revision.section.construction': 'Construction',
    'form.revision.item.new': 'New Item',
    'form.revision.item.removed': 'Removed Item',
    'form.revision.item.item': 'Item',
    'form.revision.unknownField': 'Unknown Field',
    'form.revision.action.add': 'Thêm',
    'form.revision.action.remove': 'Xóa',
    'form.revision.action.update': 'Sửa',
    'form.revision.description.clonedFrom': 'Initial version created by cloning from {{articleCode}}',
    'form.revision.description.firstVersion': 'First version of the TechPack.',
    'form.revision.description.initialCreated': 'Initial version created.',
    'form.revision.description.minorUpdates': 'Minor updates.',
    'form.revision.description.articleInfoModified': 'Product Info: {{count}} modified',
    'form.revision.description.revertedTo': 'Reverted to revision {{version}}',
    ...
    'form.invalidFileType': 'Invalid file type. Please upload JPEG, PNG, GIF, or SVG images.',
    'form.fileSizeExceeds': 'File size exceeds the 5MB limit. Please upload a smaller image.',
    ...
    'form.preview.productType': 'Product Type',
    'form.preview.productFit': 'Product Fit',
    'form.preview.productProcess': 'Product Process',
    ...
    'form.bom.noColorwayPartsAvailable': 'No colors available in this colorway.',
    ...
    'form.bom.importValidItems': 'Import {count} valid items',
    'form.bom.rowsHaveErrors': '{count} rows have errors:',
    'form.bom.row': 'Row',
    ...
    'admin.user.password.leaveBlank': 'leave blank to keep current',
    ...
    // Validation messages
    'admin.user.validation.firstName.required': 'First name is required',
    'admin.user.validation.firstName.minLength': 'First name must be at least 2 characters',
    'admin.user.validation.lastName.required': 'Last name is required',
    'admin.user.validation.lastName.minLength': 'Last name must be at least 2 characters',
    'admin.user.validation.email.required': 'Email is required',
    'admin.user.validation.email.invalid': 'Please enter a valid email address',
    'admin.user.validation.password.required': 'Password is required',
    'admin.user.validation.password.minLength': 'Password must be at least 8 characters long',
    'admin.user.validation.password.complexity': 'Password must contain at least one uppercase letter, one lowercase letter, and one number',
    'admin.user.saveError': 'Failed to save user',
    ...
    'option.productClass.shirts': 'Shirts',
    'option.productClass.blouses': 'Blouses',
    'option.productClass.tShirts': 'T-Shirts',
    'option.productClass.poloShirts': 'Polo Shirts',
    'option.productClass.pants': 'Pants',
    'option.productClass.jeans': 'Jeans',
    'option.productClass.shorts': 'Shorts',
    'option.productClass.skirts': 'Skirts',
    'option.productClass.dresses': 'Dresses',
    'option.productClass.jackets': 'Jackets',
    'option.productClass.coats': 'Coats',
    'option.productClass.sweaters': 'Sweaters',
    'option.productClass.hoodies': 'Hoodies',
    'option.productClass.underwear': 'Underwear',
    'option.productClass.swimwear': 'Swimwear',
    'option.productClass.activewear': 'Activewear',
    'option.productClass.sleepwear': 'Sleepwear',
    'option.productClass.accessories': 'Accessories',
  ...
  vi: {
    ...
    'tpl.filter.status.review': 'Đang tiến hành',
    'tpl.filter.status.approved': 'Được phê duyệt',
    ...
    'dash.stat.review': 'Đang tiến hành',
    'dash.stat.approved': 'Được phê duyệt',
    ...
    // Sample measurement rounds
    'sample.requestedSource': 'Nguồn yêu cầu',
    ...
    'sample.requested': 'Yêu cầu',
    'sample.measured': 'Đo được',
    'sample.diff': 'Sai lệch',
    'sample.revised': 'Đã sửa',
    ...
    // Status labels
    'status.draft': 'Nháp',
    'status.inReview': 'Đang tiến hành',
    ...
    'form.packing.imageColumn': 'Ảnh',
    'form.packing.noteColumn': 'Ghi chú',
    'form.packing.addButton': 'Thêm packing',
    'form.packing.noNote': 'Chưa có ghi chú',
    'form.packing.imageUploaded': 'Tải ảnh lên thành công',
    'form.packing.imageHint': 'PNG, JPG, GIF, SVG tối đa 5MB. Chỉ một ảnh packing.',
    'form.packing.deleteConfirm': 'Bạn có chắc chắn muốn xóa mục packing này không?',
    'form.packing.duplicate': 'Sao chép',
    'form.packing.empty': 'Chưa có thông tin packing. Bấm "Thêm packing" để nhập.',
    ...
    'form.revision.revisionTitle': 'Phiên bản {{version}}',
    'form.revision.byUser': 'Bởi {{name}} • {{date}}',
    'form.revision.compare': 'So sánh',
    'form.revision.revert': 'Hoàn tác',
    'form.revision.changeSummary': 'Tóm tắt thay đổi',
    'form.revision.noSummary': 'Không có tóm tắt',
    'form.revision.fieldChanges': 'Thay đổi trường',
    'form.revision.noDetailedDiff': 'Không có diff chi tiết cấp trường, nhưng đã phát hiện thay đổi:',
    'form.revision.added': 'đã thêm',
    'form.revision.modified': 'đã sửa',
    'form.revision.removed': 'đã xóa',
    'form.revision.noFieldChanges': 'Không phát hiện thay đổi cấp trường trong phiên bản này.',
    'form.revision.field': 'Trường',
    'form.revision.oldValue': 'Giá trị cũ',
    'form.revision.newValue': 'Giá trị mới',
    'form.revision.comments': 'Nhận xét',
    'form.revision.noCommentsYet': 'Chưa có nhận xét',
    'form.revision.addCommentPlaceholder': 'Thêm nhận xét...',
    'form.revision.sendComment': 'Gửi nhận xét',
    'form.revision.confirmRevert': 'Xác nhận hoàn tác',
    'form.revision.revertConfirmMessage': 'Bạn có chắc muốn hoàn tác về phiên bản <strong>{{version}}</strong>?',
    'form.revision.revertDescription': 'Hành động này sẽ tạo phiên bản mới và ghi lại lịch sử. Dữ liệu hiện tại sẽ được thay thế bằng dữ liệu từ phiên bản này.',
    'form.revision.originalSummary': 'Tóm tắt gốc:',
    'form.revision.revertReasonLabel': 'Lý do hoàn tác (tùy chọn)',
    'form.revision.revertReasonPlaceholder': 'Nhập lý do hoàn tác (nếu có)...',
    'form.revision.compareRevisions': 'So sánh phiên bản',
    'form.revision.fromRevision': 'Từ phiên bản',
    'form.revision.toRevision': 'Đến phiên bản',
    'form.revision.selectRevision': 'Chọn phiên bản',
    'form.revision.comparing': 'Đang so sánh phiên bản...',
    'form.revision.comparisonSummary': 'Tóm tắt so sánh',
    'form.revision.noDifferences': 'Không tìm thấy sự khác biệt giữa các phiên bản này.',
    'form.revision.showingFirst100': 'Hiển thị 100 trường đầu tiên',
    'form.revision.moreDifferences': 'Còn nhiều sự khác biệt khác. Sử dụng API để tải thêm trường.',
    'form.revision.cannotRevertNoSnapshot': 'Không thể hoàn tác — thiếu dữ liệu snapshot cho phiên bản này',
    'form.revision.cannotRevertRollback': 'Không được phép hoàn tác về phiên bản rollback',
    'form.revision.isCurrentRevision': 'Đây là phiên bản hiện tại',
    'form.revision.needEditorAccess': 'Bạn cần quyền Editor để hoàn tác TechPack này',
    'form.revision.section.bom': 'BOM',
    'form.revision.section.measurements': 'Kích thước',
    'form.revision.section.colorways': 'Phối màu',
    'form.revision.section.howToMeasure': 'Hướng dẫn đo',
    'form.revision.section.articleInfo': 'Thông tin sản phẩm',
    'form.revision.section.articleInformation': 'Thông tin sản phẩm',
    'form.revision.section.bomItems': 'Mục BOM',
    'form.revision.section.construction': 'Cấu trúc',
    'form.revision.item.new': 'Mục mới',
    'form.revision.item.removed': 'Mục đã xóa',
    'form.revision.item.item': 'Mục',
    'form.revision.action.add': 'Thêm',
    'form.revision.action.remove': 'Xóa',
    'form.revision.action.update': 'Sửa',
    'form.revision.description.clonedFrom': 'Phiên bản ban đầu được tạo bằng cách sao chép từ {{articleCode}}',
    'form.revision.description.firstVersion': 'Phiên bản đầu tiên của TechPack.',
    'form.revision.description.initialCreated': 'Phiên bản ban đầu đã được tạo.',
    'form.revision.description.minorUpdates': 'Cập nhật nhỏ.',
    'form.revision.description.articleInfoModified': 'Thông tin sản phẩm: {{count}} đã sửa',
    'form.revision.description.revertedTo': 'Đã hoàn tác về phiên bản {{version}}',
    ...
    'form.sharing.cannotShareHigherThanUserGlobalRole': 'Không thể chia sẻ với vai trò "{{selectedRole}}" vì người dùng {{userEmail}} có vai trò hệ thống "{{userGlobalRole}}" thấp hơn. Bạn chỉ có thể chia sẻ với các vai trò bằng hoặc thấp hơn vai trò hệ thống của người dùng.',
    ...
    'form.preview.productType': 'Chủng loại sản phẩm',
    'form.preview.productFit': 'Phom dáng sản phẩm',
    'form.preview.productProcess': 'Tiến độ sản phẩm',
    ...
    'form.bom.selectFromColorway': 'Chọn từ phối màu',
    'form.bom.enterCustomText': 'Nhập text tùy chỉnh',
    'form.bom.customColorName': 'Tên màu tùy chỉnh',
    'form.bom.enterColorName': 'Nhập tên màu...',
    'form.bom.customColorCode': 'Mã màu tùy chỉnh',
    'form.bom.enterColorCode': 'Nhập mã màu...',
    'form.bom.customColorImage': 'Ảnh màu tùy chỉnh',
    ...
    'form.bom.noColorwayPartsAvailable': 'Phối màu này chưa có màu để chọn.',
    ...
    'form.measurement.deleteConfirm': 'Bạn có chắc chắn muốn xóa "{pomCode} - {pomName}"?',
    ...
    // User Modal
    'admin.user.details': 'Chi tiết người dùng',
    'admin.user.createNew': 'Tạo người dùng mới',
    'admin.user.edit': 'Sửa người dùng',
    'admin.user.firstName': 'Tên',
    'admin.user.lastName': 'Họ',
    'admin.user.password': 'Mật khẩu',
    'admin.user.password.leaveBlank': 'để trống để giữ nguyên mật khẩu hiện tại',
    'admin.user.registered': 'Đã đăng ký',
    'admin.user.lastLogin': 'Đăng nhập cuối',
    'admin.user.never': 'Chưa bao giờ',
    'admin.user.close': 'Đóng',
    'admin.user.loading': 'Đang tải...',
    'admin.user.noUsers': 'Không tìm thấy người dùng.',
    'admin.user.view': 'Xem người dùng',
    'admin.user.delete': 'Xóa người dùng',
    
    // Validation messages
    'admin.user.validation.firstName.required': 'Tên là bắt buộc',
    'admin.user.validation.firstName.minLength': 'Tên phải có ít nhất 2 ký tự',
    'admin.user.validation.lastName.required': 'Họ là bắt buộc',
    'admin.user.validation.lastName.minLength': 'Họ phải có ít nhất 2 ký tự',
    'admin.user.validation.email.required': 'Email là bắt buộc',
    'admin.user.validation.email.invalid': 'Vui lòng nhập địa chỉ email hợp lệ',
    'admin.user.validation.password.required': 'Mật khẩu là bắt buộc',
    'admin.user.validation.password.minLength': 'Mật khẩu phải có ít nhất 8 ký tự',
    'admin.user.validation.password.complexity': 'Mật khẩu phải chứa ít nhất một chữ hoa, một chữ thường và một số',
    'admin.user.saveError': 'Lưu người dùng thất bại',
    ...
    // Options - Product Class
    'option.productClass.shirts': 'Áo sơ mi',
    'option.productClass.blouses': 'Áo blouse',
    'option.productClass.tShirts': 'Áo thun',
    'option.productClass.poloShirts': 'Áo polo',
    'option.productClass.pants': 'Quần dài',
    'option.productClass.jeans': 'Quần jean',
    'option.productClass.shorts': 'Quần short',
    'option.productClass.skirts': 'Váy',
    'option.productClass.dresses': 'Đầm',
    'option.productClass.jackets': 'Áo khoác',
    'option.productClass.coats': 'Áo choàng',
    'option.productClass.sweaters': 'Áo len',
    'option.productClass.hoodies': 'Áo hoodie',
    'option.productClass.underwear': 'Đồ lót',
    'option.productClass.swimwear': 'Đồ bơi',
    'option.productClass.activewear': 'Đồ thể thao',
    'option.productClass.sleepwear': 'Đồ ngủ',
    'option.productClass.accessories': 'Phụ kiện',
