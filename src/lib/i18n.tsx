...
const translations: Record<LanguageCode, TranslationDict> = {
  en: {
    ...
    'form.measurement.baseSizeHint': 'Base size will relate to the full size chart and the specification tables for subsequent sample runs',
  ...
  vi: {
    ...
    'form.articleInfo.sampleType': 'Phiên bản',
    ...
    'form.measurement.pomCodeColumn': 'Mã số đo',
    ...
    'option.status.inReview': 'Đang tiến hành',
