...
const translations: Record<LanguageCode, TranslationDict> = {
  en: {
    ...
    'form.articleInfo.sampleType': 'Sample Type',
    'form.articleInfo.sampleTypePlaceholder': 'Enter sample type',
    'form.articleInfo.fitType': 'Fit Type',
    'form.articleInfo.lifecycleStage': 'Lifecycle Stage',
    ...
    'form.articleInfo.pricePoint': 'Price Point',
