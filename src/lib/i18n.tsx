...
const translations: Record<LanguageCode, TranslationDict> = {
  en: {
    ...
    'clone.modal.articleCode': 'Article Code',
    'clone.modal.articleCodeRequired': 'Article code is required',
    'clone.modal.articleCodePattern': 'Article code can only contain uppercase letters, numbers, dash (-), and underscore (_)',
    'clone.modal.articleCodePlaceholder': 'Enter new article code (e.g., ABC123)',
    'clone.modal.season': 'Season (Optional)',
    ...
    'clone.modal.section.articleInfo': 'Article Info',
    ...
    'clone.modal.section.measurements': 'Measurements',
    'clone.modal.section.measurementsDesc': 'Full measurement chart and specifications',
    'clone.modal.section.construction': 'Construction',
    ...
    'clone.modal.section.packing': 'Packing',
  ...
  vi: {
    ...
    'clone.modal.season': 'Mùa (Tùy chọn)',
    ...
    'clone.modal.section.measurements': 'Thông số đo',
    'clone.modal.section.measurementsDesc': 'Bảng thông số đo đầy đủ và chi tiết',
    'clone.modal.section.construction': 'Cấu trúc',
    ...
    'clone.modal.section.packing': 'Đóng gói',
