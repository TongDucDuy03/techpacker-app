...
const translations: Record<LanguageCode, TranslationDict> = {
  en: {
    ...
    'form.sharing.cannotShareHigherRole': 'You cannot share with a role higher than your own. As a viewer, you can only share with Viewer or Factory role.',
    'form.sharing.cannotUpdateToHigherRole': 'You cannot update a user to a role higher than your own. As a viewer, you can only assign Viewer or Factory role.',
  ...
  vi: {
    ...
    'form.sharing.cannotShareHigherRole': 'Bạn không thể chia sẻ với quyền cao hơn quyền của bạn. Với quyền viewer, bạn chỉ có thể chia sẻ với quyền Viewer hoặc Factory.',
    'form.sharing.cannotUpdateToHigherRole': 'Bạn không thể cập nhật người dùng lên quyền cao hơn quyền của bạn. Với quyền viewer, bạn chỉ có thể gán quyền Viewer hoặc Factory.',
