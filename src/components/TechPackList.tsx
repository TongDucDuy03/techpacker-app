  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-lg font-semibold text-gray-900">{t('techpack.title')} Management</h3>
          <p className="text-gray-600">{t('techpack.subtitle', 'Manage your fashion technical packages')}</p>
        </div>
        <button 
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder={t('buttons.search') + ' tech packs...'}
              value={searchTerm}
          ...
          >
            ...
            <option value="Shirts">{t('techpack.categories.shirts')}</option>
            <option value="Outerwear">{t('techpack.categories.outerwear')}</option>
            <option value="Dresses">{t('techpack.categories.dresses')}</option>
            <option value="Pants">{t('techpack.categories.pants')}</option>
          </select>
      ...
      {filteredTechPacks.length === 0 && (
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Không tìm thấy Tech Pack nào</h3>
          <p className="text-gray-600 mb-6">Hãy thử điều chỉnh từ khóa hoặc bộ lọc</p>
          <button 
            onClick={handleCreateNew}
