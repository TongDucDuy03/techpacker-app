...
export const createTechPackSchema = z.object({
  body: z.object({
    ...
    // technicalDesignerId is now a free-text string (not a User reference)
    ...
    lifecycleStage: z.enum(['Concept', 'Design', 'Development', 'Pre-production', 'Production', 'Sales']).optional(),
    category: z.string().optional(),
    gender: z.enum(['Men', 'Women', 'Unisex', 'Kids']).optional(),
    brand: z.string().optional(),
    collectionName: z.string().optional(),
    targetMarket: z.string().optional(),
    pricePoint: z.enum(['Mass', 'Mid-range', 'Premium', 'Luxury']).optional(),
...
export const updateTechPackSchema = z.object({
  ...
  body: z.object({
    ...
    // technicalDesignerId is free text; accept any string
    technicalDesignerId: z.string().optional(),
    customerId: z.string().optional(),
